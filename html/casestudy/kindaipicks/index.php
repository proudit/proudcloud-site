	...
	<div id="content">
		...
		<section>
			...
			<article>
                ...
                <br>
                <p>本システムの、企画、開発、運営支援「<a href="http://www.on-sight.biz/">オンサイト(株)</a>」様、近畿大学様と十分に協議を重ね、サイト特性に合わせた安定・堅牢な現インフラ環境の提供に至りました。</p><br><br>
			</article>
          </section>
          ...
          <section>
			...
			<article>
                ...
                <p>3層構成のメリットはそれぞれを独立してスケールアップ、スケールアウトが可能なことです。AWSのロードバランサー「ELB」は負荷に応じて自動で無停止スケールアウトを行います。そのLB配下のWebサーバは冗長構成の為、片系ずつのスケールアップまたはサーバ追加してスケールアウト可能。DBはRDSのマルチAZ構成の利点である、自動フェールオーバー機能を利用することで片系ずつ、ほぼ無停止でスケールアップが可能です。</p>
